...
export interface ZegoRoomRecvTransparentMessage {
    /**
     * 发送该消息的用户
     */
    sendUser: ZegoUser;
 ...
 * 透传消息通知
 * @param roomID 房间ID
 * @param message 收到房间的透传消息
 */
type RecvRoomTransparentMessageCallBack = (roomID: string, message: ZegoRoomRecvTransparentMessage) => void;
/**
 * 房间额外消息更新回调
 *
 * @param roomID 房间ID
...
export declare enum ZegoRoomTransparentMessageMode {
...
export declare enum ZegoRoomTransparentMessageType {
    ZegoRoomTransparentMessageNormal = 0,
    ZegoRoomTransparentMessageSequence = 1
}
export interface ZegoRoomSendTransparentMessage {
