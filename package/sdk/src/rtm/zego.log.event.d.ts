...
export declare const KZMLogUpload: {
    event: string;
    file_size: (item: number) => number;
...
export declare const kZMLoginRoom: {
    ...
    error: {
        ...
        LOGIN_BEFORE_LOGOUT_BY_SAME_ROOMID: {
            code: number;
            msg: string;
        };
    };
...
export declare const kZMLogoutRoom: {
    ...
    liveroom_sid_string: (item?: string) => string | undefined;
    reason: (item?: string) => string | undefined;
};
...
export declare const kZegoConnCreateSocket: {
    event: string;
    server: (item?: string) => string | undefined;
};
...
export declare const kZegoConnDispatch: {
    ...
    http3_domain_list: (item: string[]) => string[];
    wss_v6_domain_list: (item: string[]) => string[];
    http3_v6_domain_list: (item: string[]) => string[];
};
