import { Mode } from '../plugin/zegoConnection';
...
export declare const NET_ACCESS_V6_SERVERS = "z_net_v6_access_servers";
export declare const NET_HTTP3_V6_ACCESS_SERVERS = "z_net_http3_v6_access_servers";
