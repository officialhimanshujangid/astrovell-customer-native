...
export declare class RetryRoomHandler extends RetryHandler {
    ...
    active(isFirst?: boolean, error?: ZegoError): void;
    startMaxTime(): void;
    stopMaxTime(): void;
    onactive(success: boolean, error?: ZegoError): void;
    retryLoginRoom(retryNow?: boolean, needResetSession?: boolean, err?: ZegoError): void;
    ...
    invalid(): void;
    private _zgp_handleStopRetry;
    private _zgp_getServerError;
    resetCallBack(): void;
    resetError(): void;
}
