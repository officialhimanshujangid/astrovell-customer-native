...
export declare class LiveRoomHandler {
    ...
    private get _zgp_sendCommandList();
    ...
    getHeader(cmd: number, seq: number, extra?: HeaderExtras): {
        seq: number;
        content: Uint8Array;
    };
    ...
    handlePushChannelMsg(pushReq: {
        header: any;
        body: any;
    }): void;
    handlePushTransparentMsg(pushReq: {
        header: any;
        body: any;
    }): void;
    ...
    transKeysName(obj: any, keys: string[][]): void;
    ...
    startCheck(): void;
    stopCheck(): void;
    _zgp_handleUnSendCommandList(roomId: string): void;
    ...
    sendRoomChannelMessage(bodyData: {
        channelType: number;
        msgType: number;
        msgContent: string;
        toUserIDList: string[];
    }, roomID: string, suc: SuccCallback, err: FailCallback): number;
    sendTransparentMessage(bodyData: {
        msg_type: number;
        msg_data: Uint8Array;
        to_user_list: Uint8Array[];
        client_seq: Long;
    }, roomID: string, timeout: number, suc: SuccCallback, err: FailCallback): number;
