...
export declare class RoomHandler {
    ...
    roomSpan(spanKey: any, roomID: string, reason: ZegoRoomStateChangedReason, infos: {
        error: ZegoError;
        extendedData: string;
        brokenTime?: number;
    }): void;
    transError(error: any): void;
    login(roomid: string, token: string, user: ZegoUser, config: ZegoRoomConfig | undefined, success: (success: boolean) => void, error: (err: ZegoError) => void, err?: ZegoError): void;
