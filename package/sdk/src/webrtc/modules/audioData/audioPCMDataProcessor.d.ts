import { AudioFrameOptions, ZegoAudioFrame } from '../../../../code/zh/ZegoExpressEntity.web';
...
export declare class AudioPCMDataProcessor {
    ...
    setAudioFrameCallback(stream: MediaStream, enable: boolean, callback: (data: ZegoAudioFrame) => any, options?: AudioFrameOptions): void;
