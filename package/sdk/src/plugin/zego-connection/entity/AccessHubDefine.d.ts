import { NetSocketService } from "../impl/net/NetSocketService";
...
export interface ISettingConfig {
    ...
    accesshubBypassConnectTime?: number;
    probeByPassStrategy?: ProbeStrategy;
}
...
export declare enum ProbeStrategy {
    Default = 0,
    Detail = 1
}
...
export interface IPStackDetection {
    IPv4: ZIPDetection;
    IPv6: ZIPDetection;
}
...
export declare enum SvrConnectState {
    fail = 0,
    connecting = 1,
    success = 2,
    timeout = 3
...
export interface BackToWssInfo {
    reason?: number;
    error?: any;
}
export interface ConnectServerInfo {
    ...
    tryCount: number;
    svrConnectState?: SvrConnectState;
    failTime: number;
    backToWss?: boolean;
    backToWssInfo?: BackToWssInfo;
}
export interface SocketInfo {
    service: NetSocketService;
    svrInfo: ConnectServerInfo;
}
export interface StackDetection {
    ipStackType: IPStackType;
    detection: ZIPDetection;
}
...
export interface ZegoConnectServiceEvent {
    open: (e: Event) => void;
    close: (e: Event) => void;
    error: (e: Event) => void;
    timeout: () => void;
...
export declare enum RetryLevel {
    single = 0,
    detail = 1
}
